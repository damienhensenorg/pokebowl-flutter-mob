  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            ...
            title: Text("Poké Bowl", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 31.0),),
            centerTitle: true,
            leading: Icon(Pokebowl.hamburger)
        ),
        body: Stack(
          children: <Widget>[
            Column(
                      ...
                      RaisedButton(
                        child: Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              Expanded(
                                  child: Text('Order food now', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 19.0))
                              ),
                              Icon(Pokebowl.arrow_right, color: Color(0xffFFFFFF),)
                            ],
                          ),
                        ),
